...
const Footer = () => {
  return (
    <footer className="bg-apple-darkgray text-white py-12">
      <div className="container px-4 md:px-6">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
          <div>
            ...
            <div className="space-y-2">
              <div className="flex items-center">
                <svg className="h-5 w-5 text-linkti-red mr-2" fill="currentColor" viewBox="0 0 24 24">
          ...
          <div>
            ...
            <div className="space-y-3">
              ...
              <a 
                ...
                className="flex items-center text-gray-300 hover:text-white transition-colors"
              >
                <svg className="h-5 w-5 mr-2 text-linkti-red" viewBox="0 0 24 24" fill="currentColor">
          ...
          <div>
            <h3 className="text-xl font-bold mb-4">Recuperação de Dados</h3>
            <ul className="space-y-2 text-gray-300">
              <li>• Mac & MacBook</li>
              <li>• iPhone & iPad</li>
              <li>• HD & SSD</li>
              <li>• Pen Drives & Cartões SD</li>
              <li>• RAID & Servidores Apple</li>
              <li>• Time Capsule</li>
            </ul>
            
            <Button 
              className="mt-6 bg-whatsapp hover:bg-whatsapp/90 text-white"
