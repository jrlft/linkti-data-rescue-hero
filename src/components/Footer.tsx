    ...
    <footer className="bg-apple-darkgray text-white py-12">
      <div className="container px-4 md:px-6">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
          <div>
            <h3 className="text-xl font-bold mb-4">Link TI</h3>
            ...
            <div className="space-y-2">
              <div className="flex items-center">
                <svg className="h-5 w-5 text-linkti-blue mr-2" fill="currentColor" viewBox="0 0 24 24">
          ...
          <div>
            ...
            <Button 
              className="mt-6 bg-white text-linkti-blue hover:bg-white/90"
